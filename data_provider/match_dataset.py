...
class GINMatchShuffleDataset(Dataset):
    def __init__(self, args, ids, scaf, dataset_path):
    ...
    def __getitem__(self, index):
        ...
        graph_path = self.dataset_path+'/graph/graph' + '_' + f"{self.ids[idx]}.pt"
        text_path = self.dataset_path+'/text/text' + '_' + f"{self.ids[idx]}.txt"
